...
const Nav = () => {
  ...
  <nav className='fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50'>
    <div className="container mx-auto">
      {/* nav inner */}
      <div className='w-full bg-black/20 h-[70px] backdrop-blur-2xl rounded-full max-w-[410px] mx-auto px-5 flex items-center justify-between text-xl text-white/50'>
